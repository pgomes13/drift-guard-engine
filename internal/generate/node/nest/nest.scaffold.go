...
// ScaffoldNestSwaggerScript writes a starter driftabot/scripts/generate-swagger.ts
...
func ScaffoldNestSwaggerScript(projectDir string) (string, error) {
	outPath := filepath.Join(projectDir, "driftabot", "scripts", "generate-swagger.ts")
...
func detectAppModuleRelPath(projectDir string) string {
	// Script lives at driftabot/scripts/generate-swagger.ts, so imports
