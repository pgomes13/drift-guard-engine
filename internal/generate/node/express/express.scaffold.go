...
// ScaffoldSwaggerAutogenScript writes scripts/generate-swagger.js configured
// for swagger-autogen and returns the path of the file written.
func ScaffoldSwaggerAutogenScript(projectDir string) (string, error) {
	outPath := filepath.Join(projectDir, "scripts", "generate-swagger.js")
