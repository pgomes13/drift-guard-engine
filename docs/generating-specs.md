...
The API DriftAgent auto-detects schema files in your repo. If it can't find one (you'll see "No OpenAPI schema found" in the action logs), you need to generate and commit a schema file first.
