...
The proto definition lives at [`api/drift-agent/v1/drift-agent.proto`](https://github.com/DriftAgent/api-drift-engine/blob/main/api/drift-agent/v1/drift-agent.proto).
